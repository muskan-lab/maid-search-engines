...
<!--					<select>
				...
				document.addEventListener("click", closeAllSelect);
                                 ...
                                 <form action="RecoardData.jsp" method="post" >
<!--			<p>Address:</p>
			...
			<!--<input type="text" size="50" placeholder="LastName.."><br/>-->
                        ...
                        <input type="email" name="email" placeholder="email"><br><br>
                          <input type="text" name="work_exprince" placeholder="Work_exprince.."><br><br>
                        <input type="text" name="work_type" placeholder="work_type"><br><br>                     
                       ...
                       <input style="font-size: 25px; background-color: activeborder; border-style: solid; height: 50px; width: 150px; border-radius: 10px; border-color: black;" type="submit" value="Submit"/>
                                 </form>
